...
describe('utility functions', function() {
  ...
  describe('range object', function() {
    var rangeObject = require('../rangeObject.js');
    //var range = require('../range.js');
    it('should return an object', function(){
      expect(rangeObject()).to.be.an.object;
    });

    it('should return an object range', function() {
      expect(rangeObject()).to.be.eql({});
      expect(rangeObject(3)).to.be.eql({0: 0, 1: 1, 2: 2});
      expect(rangeObject(5)).to.be.eql({0: 0, 1: 1, 2: 2, 3: 3, 4: 4});
    });
  });
